...
!!! Note While DSH Desktop uses a Windows environment, the DSH HPC cluster uses Linux. The keyboard combination "ctrl+v" will not work to paste things into Linux -- use "shift+insert" instead, which works in both Windows and Linux.

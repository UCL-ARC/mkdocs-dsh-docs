...
All use of Advanced Research Computing platforms including the DSH Research Compute environment are subject to the general [UCL Computing Regulations](https://www.ucl.ac.uk/information-security/sites/information_security/files/regulations.pdf).
...
Machines in the DSH Research Compute environment have some data storage capability, but it should not be treated as the sole repository for your data. We do not actively back up user data.

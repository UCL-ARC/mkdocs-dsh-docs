...
DSH accounts are available to be requested by approved project Information Asset Owners (IAO) and Administrators (IAA) to users internal to UCL, as well as external collaborators. Before applying for a DSH account, users must complete the [Information Governance Assurance process](https://www.ucl.ac.uk/advanced-research-computing/sensitive-data-and-trusted-research-environments), including completion of the NHS Digital’s Data Security Awareness (NHSD) course. 
